-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'ORGANIZATION', 'TEACHER', 'STUDENT');
...
-- CreateIndex
CREATE UNIQUE INDEX "ClassroomUser_userId_classroomId_key" ON "ClassroomUser"("userId", "classroomId");
